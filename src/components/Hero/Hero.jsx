    ...
    <section id="inicio" className={styles.hero} aria-label="Seção principal">
      ...
      <div className={styles.content}>
        ...
        <div className={styles.actions}>
          ...
          <a href={`https://wa.me/5567992834917?text=${encodeURIComponent('Olá! Vim pelo site Bonito Inesquecível e gostaria de saber mais sobre os destinos e pacotes disponíveis.')}`} target="_blank" rel="noopener noreferrer" className={styles.ctaSecondary} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}>
